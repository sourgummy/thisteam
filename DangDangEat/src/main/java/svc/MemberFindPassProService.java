...
public class MemberFindPassProService {
	...
	public boolean updatePass(MemberBean member) {
		System.out.println("MemberFindPassProService - updatePass");
		...
		// MemberDAO 객체의 updatePass() 메서드 호출
		// => 파라미터 : MemberBean 객체   리턴타입 : int(updateCount)
		int updateCount = dao.updatePass(member);
